...
{
    public class GetAllPricesQueryHandler : IRequestHandler<GetAllPricesQuery, IEnumerable<PriceDto>>
    {
        ...
        public async Task<IEnumerable<PriceDto>> Handle(GetAllPricesQuery query, CancellationToken ct)
        {
            var data = await _priceRepository.GetAllPricesAsync();
